...
const IMPLEMENTATION_INSTRUCTIONS = [
  ...
  "Do not propose edits to secrets, real .env files, GitHub workflows, Vercel/project settings, lockfiles, or repository configuration.",
  "You may edit exactly .env.example only as a template/documentation file for required environment variables; never include secret values.",

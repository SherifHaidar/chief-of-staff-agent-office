...
export const AppEnvSchema = z.object({
  ...
  IMPLEMENTATION_MAX_CHANGED_FILES: z.coerce.number().int().min(1).max(8).default(4),
  IMPLEMENTATION_MAX_FILE_CHARS: z.coerce.number().int().min(500).max(40000).default(16000),
  IMPLEMENTATION_MAX_TOTAL_CHANGE_CHARS: z.coerce.number().int().min(1000).max(80000).default(32000),
